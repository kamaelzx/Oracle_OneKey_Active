...
cd /root && wget -qO Fuck_OCPU.sh https://raw.githubusercontent.com/kamaelzx/Oracle_OneKey_Active/main/Fuck_OCPU.sh && chmod +X Fuck_OCPU.sh && bash Fuck_OCPU.sh ${Cores}
